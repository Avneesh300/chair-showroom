        ...
        <section className="py-12 bg-amber-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              <div>
                <h2 className="font-serif text-3xl font-bold text-amber-950 mb-1">
                  New Arrivals
                </h2>
            ...
            <div className="bg-gradient-to-r from-amber-900 to-amber-700 rounded-3xl p-8 sm:p-12 flex flex-col sm:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-amber-200 text-sm sm:text-base">
                  ...
                  order. Minimum order ₹5,000.
                </p>
              </div>

              <Link
                href="/products"
                className="bg-white text-amber-800 font-bold px-8 py-3.5 rounded-full hover:bg-amber-50 transition-colors text-sm whitespace-nowrap shadow-lg"
              >
                Shop Now
              </Link>
            </div>
